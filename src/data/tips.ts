export interface Tip {
  ...
  title: string;
  titleKn: string;
  category: 'soil' | 'water' | 'pest' | 'harvest' | 'general';
  description: string;
...
export const tips: Tip[] = [
  ...
  },
  {
    ...
    descriptionKn: 'ಲೇಡಿಬಗ್‌ಗಳು, ಲೇಸ್‌ವಿಂಗ್‌ಗಳು ಮತ್ತು ಪರಾವಲಂಬಿ ಕಣಜಗಳು ನೈಸರ್ಗಿಕ ಕೀಟ ನಿಯಂತ್ರಕಗಳು. ಅವುಗಳನ್ನು ಆಕರ್ಷಿಸಲು ಹೂವುಗಳನ್ನು ನೆಡಿ.'
  },
...
export const tipCategories = [
  { id: 'soil', icon: '🌱', nameKey: 'tipsCategorySoil' as const },
  { id: 'water', icon: '💧', nameKey: 'tipsCategoryWater' as const },
  { id: 'pest', icon: '🐛', nameKey: 'tipsCategoryPest' as const },
  { id: 'harvest', icon: '🌾', nameKey: 'tipsCategoryHarvest' as const },
  { id: 'general', icon: '📋', nameKey: 'tipsCategoryGeneral' as const }
] as const;
